...
impl TuiApp {
    ...
    fn render_shortcuts_bar(&self, f: &mut Frame, area: Rect) {
        let shortcuts = Line::from(vec![
            Span::raw(" "),
            Span::styled("↑↓", Style::default().fg(Color::Red).add_modifier(ratatui::style::Modifier::BOLD)),
            Span::raw(" Nav  "),
            Span::styled("Space", Style::default().fg(Color::Red).add_modifier(ratatui::style::Modifier::BOLD)),
            Span::raw(" Toggle  "),
            Span::styled("/", Style::default().fg(Color::Red).add_modifier(ratatui::style::Modifier::BOLD)),
            Span::raw(" Search  "),
            Span::styled("o", Style::default().fg(Color::Red).add_modifier(ratatui::style::Modifier::BOLD)),
            Span::raw(" Open  "),
            Span::styled("r", Style::default().fg(Color::Red).add_modifier(ratatui::style::Modifier::BOLD)),
            Span::raw(" Refresh  "),
    ...
    fn render_help_overlay(&self, f: &mut Frame, area: Rect) {
        ...
        let content = Text::from(vec![
            ...
            Line::from(vec![
                Span::styled("↑", Style::default().fg(Color::Red).add_modifier(ratatui::style::Modifier::BOLD)),
                Span::styled("/k", Style::default().fg(Color::Red).add_modifier(ratatui::style::Modifier::BOLD)),
                Span::raw("   Move selection up"),
            ]),
            Line::from(vec![
                Span::styled("↓", Style::default().fg(Color::Red).add_modifier(ratatui::style::Modifier::BOLD)),
                Span::styled("/j", Style::default().fg(Color::Red).add_modifier(ratatui::style::Modifier::BOLD)),
                Span::raw("   Move selection down"),
            ]),
            Line::from(vec![Span::styled("g", Style::default().fg(Color::Red).add_modifier(ratatui::style::Modifier::BOLD)), Span::raw("        Go to top of list")]),
            Line::from(vec![Span::styled("G", Style::default().fg(Color::Red).add_modifier(ratatui::style::Modifier::BOLD)), Span::raw("        Go to bottom of list")]),
            Line::from(vec![Span::raw("")]),
            Line::from(vec![Span::styled(" Actions ", Style::default().fg(Color::Cyan).add_modifier(ratatui::style::Modifier::BOLD))]),
            Line::from(vec![Span::raw("")]),
            Line::from(vec![Span::styled("Space", Style::default().fg(Color::Red).add_modifier(ratatui::style::Modifier::BOLD)), Span::raw("     Toggle selected item on/off")]),
            Line::from(vec![Span::styled("o", Style::default().fg(Color::Red).add_modifier(ratatui::style::Modifier::BOLD)), Span::raw("        Open item location in Finder")]),
            Line::from(vec![Span::styled("/", Style::default().fg(Color::Red).add_modifier(ratatui::style::Modifier::BOLD)), Span::raw("        Focus search input")]),
            Line::from(vec![Span::styled("Esc", Style::default().fg(Color::Red).add_modifier(ratatui::style::Modifier::BOLD)), Span::raw("      Clear search / close dialogs")]),
            Line::from(vec![Span::styled("r", Style::default().fg(Color::Red).add_modifier(ratatui::style::Modifier::BOLD)), Span::raw("        Refresh all items")]),
            Line::from(vec![Span::raw("")]),
            Line::from(vec![Span::styled("q", Style::default().fg(Color::Red).add_modifier(ratatui::style::Modifier::BOLD)), Span::raw("        Exit application")]),
            Line::from(vec![Span::raw("")]),
